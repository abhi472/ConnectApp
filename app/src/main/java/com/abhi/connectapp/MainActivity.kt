...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupPermissionLauncher() {
        requestPermissionLauncher = registerForActivityResult(
            ...
            if (allGranted) {
                ...
                // You can proceed with app logic that requires these permissions
                // For now, just a toast. Specific permissions will be checked when needed.
            } else {
    ...
    private fun requestInitialPermissions() {
        ...
        // Storage Permissions (for images in WiFi section)
    ...
    private fun setupRecyclerView() {
        val options = listOf(
            ...
            ConnectivityOption("BLE (Bluetooth Low Energy)", Constants.CONNECTION_TYPE_BLE),
            ConnectivityOption("Wi-Fi Direct", Constants.CONNECTION_TYPE_WIFI)
        )
